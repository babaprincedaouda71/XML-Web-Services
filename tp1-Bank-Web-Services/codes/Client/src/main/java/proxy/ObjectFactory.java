...
public class ObjectFactory {
    ...
    private final static QName _Convert_QNAME = new QName("http://tp1/", "Convert");
    private final static QName _ConvertResponse_QNAME = new QName("http://tp1/", "ConvertResponse");
    private final static QName _GetAccount_QNAME = new QName("http://tp1/", "getAccount");
    private final static QName _GetAccountResponse_QNAME = new QName("http://tp1/", "getAccountResponse");
    private final static QName _ListAccounts_QNAME = new QName("http://tp1/", "listAccounts");
    private final static QName _ListAccountsResponse_QNAME = new QName("http://tp1/", "listAccountsResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://tp1/", name = "Convert")
     ...
     */
    @XmlElementDecl(namespace = "http://tp1/", name = "ConvertResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://tp1/", name = "getAccount")
     ...
     */
    @XmlElementDecl(namespace = "http://tp1/", name = "getAccountResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://tp1/", name = "listAccounts")
     ...
     */
    @XmlElementDecl(namespace = "http://tp1/", name = "listAccountsResponse")
